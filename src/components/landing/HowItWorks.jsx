...
export default function HowItWorkds() {
    return (
        <div className='py-10'>
            <h2 className='text-center text-3xl font-medium mt-10'>COMO FUNCIONA</h2>
            <div className='w-full grid grid-template-areas-HowItWorks gap-4'>
                <Card
                ...
                <Arrow className="text-secondary grid-area-arrow1" />
                ...
                <Arrow className="text-secondary rotate-90 grid-area-arrow2" />
                ...
                <Arrow className="text-secondary grid-area-arrow3" />
